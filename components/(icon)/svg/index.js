export function Svg_Facebook({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={w} height={h} fill={c ? c : 'var(--main)'}>
...
export function Svg_Menu({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={w} height={h} fill={c ? c : 'var(--main)'}>
...
export function Svg_Mode({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width={w} height={h} fill={c ? c : 'var(--main)'}>
...
export function Svg_Left({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width={w} height={h} fill={c ? c : 'var(--main)'}>
...
export function Svg_Student({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width={w} height={h} fill={c ? c : 'var(--main)'}>
...
export function Svg_Chart({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width={w} height={h} fill={c ? c : 'var(--main)'}>
...
export const Svg_Delete = ({ w, h, c }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={w} height={h} viewBox="0 0 448 512" fill={c ? c : 'var(--main)'}>
...
export const Svg_Chat = ({ w, h, c }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={w} height={h} fill={c ? c : 'var(--main_d)'}>
...
export const Svg_Map = ({ w, h, c }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width={w} height={h} fill={c ? c : 'var(--main_d)'}>
...
export const Svg_Check = ({ w, h, c }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width={w} height={h} fill={c ? c : 'var(--main_d)'}>
...
export const Svg_Qr = ({ w, h, c }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={w} height={h} fill={c ? c : 'var(--main_d)'}>
